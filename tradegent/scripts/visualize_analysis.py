...
def generate_svg(data: dict) -> str:
    ...
    svg = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1020" font-family="Arial, sans-serif">
  <defs>
...
'''
  ...
  <text x="600" y="1014" font-size="10" fill="#868e96" text-anchor="middle">Generated by Tradegent v{version} Stock Analysis Framework | Data as of {escape_xml(analysis_date)}</text>
</svg>'''
