...
4. Store output in corresponding `trading-knowledge/` folder

## File Naming Convention

All outputs use: `{TICKER}_{YYYYMMDDHHMM}.yaml`

Example: `NVDA_202501200900.yaml`

## Integration with trading-knowledge

```
trading-skills/          →    trading-knowledge/
─────────────────────────────────────────────────
