...
**Skill:** `skills/document-creation/` (earnings section)
...
**Skill:** `skills/document-creation/` (stock section)
...
**Skill:** `skills/document-creation/` (research section)
...
**Skill:** `skills/document-creation/` (ticker section)
